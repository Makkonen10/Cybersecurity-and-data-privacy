...
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 2xx | 29 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 3xx | 3 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 4xx | 23 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 5xx | 43 % |
