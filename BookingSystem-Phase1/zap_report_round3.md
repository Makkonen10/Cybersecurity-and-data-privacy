...
[2026-02-16-ZAP-Report-.md](https://github.com/user-attachments/files/25348161/2026-02-16-ZAP-Report-.md)
...
| --- | --- | --- | --- | --- |
| Medium | Exceeded Low |  | Percentage of memory used | 81    |
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 66    |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 2xx | 51 % |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 3xx | 37 % |
| Info | Exceeded Low | http://localhost:8003 | Percentage of responses with status code 4xx | 10 % |
