...
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 92    |
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 2xx | 45 % |
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 3xx | 38 % |
